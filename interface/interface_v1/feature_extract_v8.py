...
import copy
import sys
#import mahjongEnv.mah_tool.tool as tool
import mah_tool.tool as tool
# 1通常手向听数
...
def calculate_noking_sys_2_dqn(handCards, actions):
    ...
    # 5-9 万，条，筒，风，箭个数
    hand_cards = copy.deepcopy(handCards)#14,14,14,12
    f5_9 = numOfCards(hand_cards)
    feature = feature + f5_9
    ...
    # 44-67 ab
    feature2=[]
    hand_cards = copy.deepcopy(handCards)   #4
    f44_67 = ab(hand_cards)
