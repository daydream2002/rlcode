...
# a = dataset.get_next_batch('val')[0].reshape(-1, 1274, 34, 1)
# print(len(dataset.train_loader))
# print(dataset.get_next_batch('val')[0].shape)
# print(dataset.get_next_batch('val')[1].shape)
# print(a.shape)
...
model.save(
    "./save_premodel/suphx_features455_premodel_lr2.5e-4_ep100_ppo2_lr2.5-4_nsteps1024_res34tf_noGang_abort-1_1pzhiyi",
    True)
